import type * as React from '@react-navigation/stack/lib/typescript/src/node_modules/react';
import type { Animated, StyleProp, TextStyle, ViewStyle, LayoutChangeEvent } from 'react-native';
import type { EdgeInsets } from '@react-navigation/stack/lib/typescript/src/node_modules/react-native-safe-area-context';
import type { NavigationProp, ParamListBase, Descriptor, Route, NavigationHelpers, StackNavigationState, StackActionHelpers, RouteProp } from '@react-navigation/stack/lib/typescript/src/node_modules/@react-navigation/native';
